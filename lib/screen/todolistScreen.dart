...
// Add this callback to TodoListScreen
typedef TodoListCallback = void Function(List<Todo>);

class TodoListScreen extends StatefulWidget {
  final TodoListCallback onTodoListUpdated;

  TodoListScreen({required this.onTodoListUpdated});
...
class _TodoListScreenState extends State<TodoListScreen> {
  ...
  void _loadTodos() async {
    ...
    // Call the callback function to update the list in the parent widget
    widget.onTodoListUpdated(_todos);
  }
